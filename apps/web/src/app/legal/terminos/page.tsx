  ...
  return (
    <div className="min-h-screen bg-slate-50 py-12 px-4">
      <div className="max-w-2xl mx-auto bg-white rounded-3xl shadow-sm border border-slate-100 p-8">
        ...
        <h1 className="text-2xl font-bold text-slate-900 mb-2">Términos de Uso</h1>
        ...
        <div className="prose prose-slate max-w-none text-slate-600 text-sm leading-relaxed space-y-6">
          ...
          <section>
            <h2 className="text-base font-semibold text-slate-800 mb-2">2. Uso aceptable</h2>
            <p>
          ...
          <section>
            <h2 className="text-base font-semibold text-slate-800 mb-2">3. Cuentas y acceso</h2>
            <p>
          ...
          <section>
            <h2 className="text-base font-semibold text-slate-800 mb-2">4. Contenido del usuario</h2>
            <p>
          ...
          <section>
            <h2 className="text-base font-semibold text-slate-800 mb-2">5. Disponibilidad</h2>
            <p>
          ...
          <section>
            <h2 className="text-base font-semibold text-slate-800 mb-2">7. Cambios en los términos</h2>
            <p>
