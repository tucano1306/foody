...
// Route map: NestJS paths → Next.js API route paths
// This proxy now forwards to the internal Next.js API routes,
// which handle all DB operations directly via @neondatabase/serverless.
function mapPath(nestPath: string): string {
  // NestJS used kebab-case which matches our Next.js routes
  return nestPath;
}
