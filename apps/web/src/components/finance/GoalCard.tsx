...
export default function GoalCard({ goal, index, onContribute, onEdit, onDelete, onComplete, dragHandle }: Props) {
  ...
  return (
    /* Aquí había un gesto de deslizar con una capa detrás que decía «Aportar»
       y «Eliminar». La tarjeta es translúcida (`bg-sky-50/70`), así que esa capa
       se transparentaba SIEMPRE —no solo al arrastrar— y esas dos palabras
       aparecían impresas encima de «Falta» y «Plan asignado». Además el gesto
    ...
    <motion.article
      ...
      className="relative rounded-3xl border border-sky-100 bg-sky-50/70 shadow-sm overflow-hidden"
    >
      {/* Encabezado pastel */}
